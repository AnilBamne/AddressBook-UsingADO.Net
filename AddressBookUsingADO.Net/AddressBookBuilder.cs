...
namespace AddressBookUsingADO.Net
{
    public class AddressBookBuilder
    {
        ...
        /// <summary>
        /// Ability to show all data by City or State
        /// </summary>
        /// <param name="addressBookModel"> object of AddressBookModel</param>
        public void GetAllDataByCityOrState()
        {
            try
            {
                AddressBookModel addressBookModel = new AddressBookModel();
                using (this.connection)
                {
                    string query = @"Select * From AddressBookTable Where City='Bidar' or State='Karnataka';";
